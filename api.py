...
class LibreTranslateAPI:
    ...
    def translate(self, q: str, source: str = "en", target: str = "es", timeout: Union[int, None] = None) -> Any:
        """Translate string
    ...
    def detect(self, q: str, timeout: Union[int, None] = None) -> Any:
    ...
    def languages(self, timeout: Union[int, None] = None) -> Any:
